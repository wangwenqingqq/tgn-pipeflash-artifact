...
def main():
    ...
    args=p.parse_args();args.parameter_transport='packed';world=int(os.environ.get('WORLD_SIZE','1'));rank=int(os.environ.get('RANK','0'))
    ...
    if world>1:
        from packed_parameters import install as install_packed_parameters
        install_packed_parameters(ns)
