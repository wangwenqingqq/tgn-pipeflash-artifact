...
def main():
    ...
    args=p.parse_args();args.prefix_snapshot=True;args.inline_state_send=True;args.parameter_transport='arena';world=int(os.environ.get('WORLD_SIZE','1'));rank=int(os.environ.get('RANK','0'))
